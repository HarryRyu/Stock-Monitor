let express,WatchListService,StockListService,DailyTimeSeriesService,QuestradeController;_f5f‍.x([["default",()=>_f5f‍.o]]);_f5f‍.w("express",[["default",["express"],function(v){express=v}]]);_f5f‍.w("../../database/WatchList/service",[["default",["WatchListService"],function(v){WatchListService=v}]]);_f5f‍.w("../../database/StockList/service",[["default",["StockListService"],function(v){StockListService=v}]]);_f5f‍.w("../../database/DailyTimeSeries/service",[["default",["DailyTimeSeriesService"],function(v){DailyTimeSeriesService=v}]]);_f5f‍.w("../../controller/questradeController",[["default",["QuestradeController"],function(v){QuestradeController=v}]]);
...
router.post('/retrieveWatchlistHistoricalData', async (req, res, next) => {
    ...
    _f5f‍.g.console.log(timeInterval)
    try {
        const watchList = await StockListService.findByIds(query);
        ...
        if (timeInterval === "OneMonth"){
            ...
            for (let i = 0; i < 31; i++) {
                ...
                _f5f‍.g.console.log(output[i].change)
            }
        }
